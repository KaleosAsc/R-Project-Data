...
- `cache_traduccion.rds`: Dataset con traducciones procesadas
- `modelo_nb`: Modelo entrenado de Naive Bayes (puede ser exportado con `saveRDS()`)
- Gráficos de evaluación en formato PNG/PDF
