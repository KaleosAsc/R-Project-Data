...
-1. ¿Qué características textuales y de usuario, influyen con mayor frecuencia en la generación de reseñas falsas o de tipo spam?
-2. ¿Existen diferencias significativas en la proporción de reseñas falsas entre distintos idiomas o categorías de aplicación móviles?
-3. ¿Puedes el algoritmo Naive Bayes Multinomial clasificar con precisión aceptable (superior al 70%) las reseñas falsas basándose en el contenido textual y variables complementarias?
...
-1. H1: Las reseñas con lenguaje repetitivo, puntuaciones extremas y sin verificación de compra presentan mayor probabilidad de ser clasificadas como spam. 
-2. H2: El algoritmo naives bayes, es capaz de detectar reseñas falsas con un nivel de precision superior al 80%.
-3. H3: Existen diferencias significativas entre idiomas en la frecuencia de reseñas falsas, debido a la diversidad linguística y cultural de los usuarios. 
-4. H4: Variables demográficas Como edad y país del usuario influyen en el comportamiento de publicación de reseñas falsas o auténticas
-5 H5: La combinación de texto y metadatos, mejora el rendimiento del modelo frente a usar solo texto. 

Estas preguntas e hipótesis orienta a la minería de datos a: 
